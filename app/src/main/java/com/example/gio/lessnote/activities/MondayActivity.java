...
//=========================================================================
    ...
    private void initView() {
        ...
        et_les_1.setText(LessNoteApplication.getInstce().getSharedString(MON_LESS_1));
        et_les_2 = (EditText) findViewById(R.id.et_les_2);
        et_les_2.setText(LessNoteApplication.getInstce().getSharedString(MON_LESS_2));
        et_les_3 = (EditText) findViewById(R.id.et_les_3);
        et_les_3.setText(LessNoteApplication.getInstce().getSharedString(MON_LESS_3));
        et_les_4 = (EditText) findViewById(R.id.et_les_4);
        et_les_4.setText(LessNoteApplication.getInstce().getSharedString(MON_LESS_4));
        et_les_5 = (EditText) findViewById(R.id.et_les_5);
        et_les_5.setText(LessNoteApplication.getInstce().getSharedString(MON_LESS_5));
    ...
    public void onBackPressed() {
        LessNoteApplication.getInstce().setSharedString(MON_LESS_1, et_les_1.getText().toString());
        LessNoteApplication.getInstce().setSharedString(MON_LESS_2, et_les_2.getText().toString());
        LessNoteApplication.getInstce().setSharedString(MON_LESS_3, et_les_3.getText().toString());
        LessNoteApplication.getInstce().setSharedString(MON_LESS_4, et_les_4.getText().toString());
        LessNoteApplication.getInstce().setSharedString(MON_LESS_5, et_les_5.getText().toString());
        LessNoteApplication.getInstce().setSharedString(MON_LESS_6, et_les_6.getText().toString());
        LessNoteApplication.getInstce().setSharedString(MON_LESS_7, et_les_7.getText().toString());
        super.onBackPressed();
    }
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        if (id == DIALOG_ID_1) {
            return new TimePickerDialog(MondayActivity.this, monTimePickerListener1, hours1, minutes1, false);
        } else if (id == DIALOG_ID_2) {
            return new TimePickerDialog(MondayActivity.this, monTimePickerListener2, hours2, minutes2, false);
        } else if (id == DIALOG_ID_3) {
            return new TimePickerDialog(MondayActivity.this, monTimePickerListener3, hours3, minutes3, false);
        } else if (id == DIALOG_ID_4) {
            return new TimePickerDialog(MondayActivity.this, monTimePickerListener4, hours4, minutes4, false);
        } else if (id == DIALOG_ID_5) {
            return new TimePickerDialog(MondayActivity.this, monTimePickerListener5, hours5, minutes5, false);
        } else if (id == DIALOG_ID_6) {
            return new TimePickerDialog(MondayActivity.this, monTimePickerListener6, hours6, minutes6, false);
        } else if (id == DIALOG_ID_7) {
            return new TimePickerDialog(MondayActivity.this, monTimePickerListener7, hours7, minutes7, false);
        }
        return null;
    }
...
//    }
    ...
    protected TimePickerDialog.OnTimeSetListener monTimePickerListener1 = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            LessNoteApplication.getInstce().setSharedInt(MON_HOUR_1, hours1);
            LessNoteApplication.getInstce().setSharedInt(MON_MINUTE_1, minutes1);
    ...
    protected TimePickerDialog.OnTimeSetListener monTimePickerListener2 = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            LessNoteApplication.getInstce().setSharedInt(MON_HOUR_2, hours2);
            LessNoteApplication.getInstce().setSharedInt(MON_MINUTE_2, minutes2);
    ...
    protected TimePickerDialog.OnTimeSetListener monTimePickerListener3 = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            LessNoteApplication.getInstce().setSharedInt(MON_HOUR_3, hours3);
            LessNoteApplication.getInstce().setSharedInt(MON_MINUTE_3, minutes3);

            Connections.setTvTime(tv_time_3, hours3, hours3);
        }
    };
    ...
    protected TimePickerDialog.OnTimeSetListener monTimePickerListener4 = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            LessNoteApplication.getInstce().setSharedInt(MON_HOUR_4, hours4);
            LessNoteApplication.getInstce().setSharedInt(MON_MINUTE_4, minutes4);
    ...
    protected TimePickerDialog.OnTimeSetListener monTimePickerListener5 = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            LessNoteApplication.getInstce().setSharedInt(MON_HOUR_5, hours5);
            LessNoteApplication.getInstce().setSharedInt(MON_MINUTE_5, minutes5);
    ...
    protected TimePickerDialog.OnTimeSetListener monTimePickerListener6 = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            LessNoteApplication.getInstce().setSharedInt(MON_HOUR_6, hours6);
            LessNoteApplication.getInstce().setSharedInt(MON_MINUTE_6, minutes6);
    ...
    protected TimePickerDialog.OnTimeSetListener monTimePickerListener7 = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            LessNoteApplication.getInstce().setSharedInt(MON_HOUR_7, hourOfDay);
            LessNoteApplication.getInstce().setSharedInt(MON_MINUTE_7, minutes7);
